...
#ifdef __BIG_ENDIAN
#define rSDIDAT    (*(volatile unsigned *)0x5a000043)	//SDI data
...
// Interrupt vector
#define aISR_EINT0		(_ISR_STARTADDRESS+0x20)
...
#define pISR_WDT  		pISR_WDT_AC97								//Added for 2440 by David
...
#define BIT_WDT			BIT_WDT_AC97	// Added for 2440 by David
